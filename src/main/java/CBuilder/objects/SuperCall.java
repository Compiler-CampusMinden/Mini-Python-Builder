...
/**
 * Create a new super call for a class definition. All classes need to call super since they inherit
 * from '__MPyType_Object'. The super call need to be the first statement of '__init__' method.
 */
